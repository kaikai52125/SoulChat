...
研究 / 定时任务 / 协作模式 / 未来扩展 各自有自己的 rubric。Rubric 字段定义直接对齐 ① 离线评测的指标
...
from app.core.agent.loop.rubric.collaboration import COLLABORATION_RUBRIC
...
__all__ = ["RUBRICS", "RESEARCH_RUBRIC", "TASK_RUBRIC", "COLLABORATION_RUBRIC"]
